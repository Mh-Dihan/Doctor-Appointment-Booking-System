  ...
  return (
    <div>
        ...
        <div className='my-10 flex flex-col md:flex-row gap-x-12'>
          ...
          <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
            <p>Welcome to Prescripto, your trusted partner in managing your healthcare needs 
              conveniently and efficiently. At Prescripto, we understand the challenges individuals face when it comes to scheduling doctor appointments and managing their health records.</p>
        ...
        <div className='text-xl my-4'>
          <p className='font-semibold text-gray-900'><span className='text-gray-700 font-semibold'>WHY</span> CHOOSE US</p>
        </div>
